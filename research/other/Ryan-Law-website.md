...
1. How present you are in the data the model learned from.
2. How often you show up in the content it retrieves at answer time.
3. And just as importantly, the context you appear in.
...
* Agent A: the AI marketing agent from Ahrefs
...
> * AI-assisted content is already everywhere: we studied 900,000 pages and found that **74%** of new webpages include AI-generated content.
> * It also doesn’t hurt you. Across 600,000 pages, we found that AI-generated content **does not hurt your Google rankings**, and **86.5%** of top-ranking pages already contain some AI content.
> * In AI search it’s the same story: in our analysis of pages cited in AI Overviews, **87.8%** were at least AI-assisted, and the correlation between how much AI a page used and where it ranked was 0.017, effectively zero.
